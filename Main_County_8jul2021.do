...
coefplot (mBiS_High, label("Science Skepticism = Low") color(blue%75) recast(connected) ciopts(recast(rcap) color(blue%50))) (mBiS_Low, label("Science Skepticism = High") color(gray%75) recast(connected) ciopts(recast(rcap) color(gray%50))), ///
	...
	estout mBiS_High mBiS_Low using "${tabs}/county_eventstudy_noweights_$add.tex", mlabels(none) ///
...
**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~**
**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~**
** POP WEIGHTED EVENT STUDY DESIGN: X
**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~**
**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~**
...
coefplot (mBiS_High, label("Science Skepticism = Low") color(blue%75) recast(connected) ciopts(recast(rcap) color(blue%50))) (mBiS_Low, label("Science Skepticism = High") color(gray%75) recast(connected) ciopts(recast(rcap) color(gray%50))), ///
	...
	graph export "${figs}/county_eventstudy_popweights_5.pdf", replace
...
**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~**
**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~**
// UNWEIGHTED POOLED EVENT STUDY DESIGN: FULL TABLE
**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~**
**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~**
...
mat rownames CS = Benchmark \hspace{2mm}+Voting \hspace{2mm}+Rural \hspace{2mm}+Education \hspace{2mm}+Income ///
	\hspace{2mm}+Religiosity \hspace{2mm}+InstHealth \hspace{2mm}+GovtPolicies \hspace{2mm}+LocalCOVID \hspace{2mm}+StateCOVID \hspace{2mm}+SiPCOVID

estout matrix(CS, fmt(3 3 3 2 3 0 0)) using "${tabs}/county_pooleventstudy_noweights_expand_$add.tex", mlabels(none) replace style(tex) ///
...
**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~**
**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~**
// POP WEIGHTED POOLED EVENT STUDY DESIGN: X
**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~**
**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~**

eststo clear

	eststo m1: `outputoption' reghdfe sd_pcthome dd 1.dd#1.BiS_High [aweight=pop], absorb(i.ncounty i.date_smart) vce(cluster i.ncounty i.date_smart i.nstate#i.week) nocons
	estadd scalar df = e(N_full) -  e(df_a_nested) - e(df_m) 

	eststo m2: `outputoption' reghdfe sd_pcthome dd 1.dd#1.BiS_High 1.dd#1.trump [aweight=pop], absorb(i.ncounty i.date_smart) vce(cluster i.ncounty i.date_smart i.nstate#i.week) nocons
	estadd scalar df = e(N_full) -  e(df_a_nested) - e(df_m) 

	eststo m3: `outputoption' reghdfe sd_pcthome dd 1.dd#1.BiS_High 1.dd#1.trump 1.dd#1.aboveMedrural [aweight=pop], absorb(i.ncounty i.date_smart) vce(cluster i.ncounty i.date_smart i.nstate#i.week) nocons
	estadd scalar df = e(N_full) -  e(df_a_nested) - e(df_m) 

	eststo m4: `outputoption' reghdfe sd_pcthome dd 1.dd#1.BiS_High 1.dd#1.trump 1.dd#1.aboveMedrural 1.dd#1.aboveMedbachelor [aweight=pop], absorb(i.ncounty i.date_smart) vce(cluster i.ncounty i.date_smart i.nstate#i.week) nocons
	estadd scalar df = e(N_full) -  e(df_a_nested) - e(df_m) 

	eststo m5: `outputoption' reghdfe sd_pcthome dd 1.dd#1.BiS_High 1.dd#1.trump 1.dd#1.aboveMedrural 1.dd#1.aboveMedbachelor 1.dd#1.aboveMedmdn_inc [aweight=pop], absorb(i.ncounty i.date_smart) vce(cluster i.ncounty i.date_smart i.nstate#i.week) nocons
	estadd scalar df = e(N_full) -  e(df_a_nested) - e(df_m) 

	eststo m6: `outputoption' reghdfe sd_pcthome dd 1.dd#1.BiS_High 1.dd#1.trump 1.dd#1.aboveMedrural 1.dd#1.aboveMedbachelor 1.dd#1.aboveMedmdn_inc 1.dd#1.aboveMedreligion [aweight=pop], absorb(i.ncounty i.date_smart) vce(cluster i.ncounty i.date_smart i.nstate#i.week) nocons
	estadd scalar df = e(N_full) -  e(df_a_nested) - e(df_m) 

	eststo m7: `outputoption' reghdfe sd_pcthome dd 1.dd#1.BiS_High 1.dd#1.trump 1.dd#1.aboveMedrural 1.dd#1.aboveMedbachelor 1.dd#1.aboveMedmdn_inc 1.dd#1.aboveMedreligion 1.dd#1.aboveMedinstitutionalhealth [aweight=pop], absorb(i.ncounty i.date_smart) vce(cluster i.ncounty i.date_smart i.nstate#i.week) nocons
	estadd scalar df = e(N_full) -  e(df_a_nested) - e(df_m) 

	eststo m8: `outputoption' reghdfe sd_pcthome dd 1.dd#1.BiS_High 1.dd#1.trump 1.dd#1.aboveMedrural 1.dd#1.aboveMedbachelor 1.dd#1.aboveMedmdn_inc 1.dd#1.aboveMedreligion 1.dd#1.aboveMedinstitutionalhealth soe bus school [aweight=pop], absorb(i.ncounty i.date_smart) vce(cluster i.ncounty i.date_smart i.nstate#i.week) nocons
	estadd scalar df = e(N_full) -  e(df_a_nested) - e(df_m) 
	...
	graph export "${figs}/county_pooleventstudy_popweights_expand_5.pdf", replace
...
estout matrix(CS, fmt(3 3 3 2 3 0 0)) using "${tabs}/county_pooleventstudy_popweights_expand_trip_$add.tex", mlabels(none) replace style(tex) ///
	collabels("Coeff.""SE""p-val.""t-Stat." "R\textsuperscript{2}" "DoF" "Obs.")  /// 
	prehead(\begin{tabular}{lccccccc} \hline \hline \rule{0pt}{3ex}) ///
	posthead(\hline ) postfoot( \hline \end{tabular}) 
...
estout matrix(CS, fmt(3 3 3 2 3 0 0)) using "${tabs}/county_pooleventstudy_popweights_expand_tripALL_$add.tex", mlabels(none) replace style(tex) ///
	collabels("Coeff.""SE""p-val.""t-Stat." "R\textsuperscript{2}" "DoF" "Obs.")  /// 
	prehead(\begin{tabular}{lccccccc} \hline \hline \rule{0pt}{3ex}) ///
	posthead(\hline ) postfoot( \hline \end{tabular}) 
...
eststo clear
	...
	graph export "${figs}/county_pooleventstudy_popweights_expand_essential_$add.pdf", replace
...
estout matrix(CS, fmt(3 3 3 2 3 0 0)) using "${tabs}/county_pooleventstudy_popweights_expand_essential_$add.tex", mlabels(none) replace style(tex) ///
	collabels("Coeff.""SE""p-val.""t-Stat." "R\textsuperscript{2}" "DoF" "Obs.")  /// 
	prehead(\begin{tabular}{lccccccc} \hline \hline \rule{0pt}{3ex}) ///
	posthead(\hline ) postfoot( \hline \end{tabular}) 
