...
global controls = "rural bachelor mdn_inc institutionalhealth religion pop" // which controls to split by
//also add population now
...
global dir "/Users/Adam/Dropbox/coronaScience" 
...
foreach i of numlist 1/3 { // run simple dd models

	if `i' == 1 { // simple dd
		global fmla_dd = "$fmla dd 1.dd#1.aboveMed$clim "
	} 
	else { 
		if `i' == 2 { // simple dd but with trump
		global fmla_dd = "$fmla dd 1.dd#1.aboveMed$clim 1.dd#1.trump"
		}
	else {	// simple dd + interactions
		global dd_vars = "dd 1.dd#1.aboveMed$clim 1.dd#1.trump 1.dd#1.aboveMedrural 1.dd#1.aboveMedbachelor 1.dd#1.aboveMedmdn_inc 1.dd#1.aboveMedreligion 1.dd#1.aboveMedinstitutionalhealth 1.dd#1.aboveMedpop"
