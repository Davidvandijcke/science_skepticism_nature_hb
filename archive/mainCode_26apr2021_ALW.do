...
// set base path and other paths <-- change this : "/Users/Adam/Dropbox/coronaScience" "/home/antonvocalis/Dropbox (University of Michigan)/Documents/coronaScience" 
global dir "/Users/austinlw/Dropbox/coronaScience" 
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
// NOTE THE CHANGE IN PANEL DATE RANGE // 
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
...
gen trump = (republican > 0.5) & republican!=.
gen dem = (0.5 < democrat) & democrat!=.
...
// LONGER PANEL RESULTS ROBUST TO DROPPING PR
...
gen dsfips = countyfips
	
	destring dsfips, force replace
	
rename fips fips_legacy

rename dsfips fips

sort fips

merge fips using "/Users/austinlw/Harris-Public-Policy Dropbox/Austin Wright/unmasking_partisanship/data/county_level/Trade_Data/master_county.dta"

tab state2 if _merge==2
...
foreach i of numlist 1/2 { // run simple dd models
	...
	eststo: reghdfe $fmla_dd  1.dd#1.trump, absorb(i.ncounty i.date2) /// 
...
esttab using "${tabs}/simpleDD.tex", style(tex) nobaselevels compress  ///
	nonumbers keep(1.dd#1.trump $dd_vars) label se nodepvars /// label and var options
	...
	"Lockdown $\times$ Science (=1)" 1.dd#1.trump ///
	"Lockdown $\times$ Republican (=1)" 1.dd#1.aboveMedrural  ///
...
// Population weights for simple DiD
...
foreach i of numlist 1/2 { // run simple dd models
	...
	// Fixed Effects Regression
	eststo: reghdfe $fmla_dd [aweight=pop], absorb(i.ncounty i.date2) /// 
	vce(cluster i.ncounty i.date2 i.nstate#i.week) nocons 
	estadd local fe "Yes"
...
// Latex output
esttab using "${tabs}/simpleDD_popweights.tex", style(tex) nobaselevels compress  ///
